...
This file is the top-level entry point for active planning documents. Detailed plan content lives
under `docs/plans/`.
...
This file has been intentionally reduced. Future execution notes and active planning state should
be rewritten here as needed.
