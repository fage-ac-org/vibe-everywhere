...
if [[ "$MODE" == "overlay" ]]; then
  ...
  EASYTIER_STATUS_POLL_SECS=${VIBE_TEST_EASYTIER_STATUS_POLL_SECS:-1}
  ...
  OVERLAY_BOOTSTRAP_URLS=${VIBE_TEST_OVERLAY_BOOTSTRAP_URLS:-tcp://$OVERLAY_BOOTSTRAP_HOST:$EASYTIER_PORT,udp://$OVERLAY_BOOTSTRAP_HOST:$EASYTIER_PORT,tcp://$HOST:$EASYTIER_PORT,udp://$HOST:$EASYTIER_PORT}
